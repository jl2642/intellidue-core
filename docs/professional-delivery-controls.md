...
This additive control layer validates the professional product topology that sits above
the existing deterministic package and private-runtime controls.

It adds:

- local intake receipts that prohibit analysis during custody;
- source-review coverage receipts that separate registration from professional review;
